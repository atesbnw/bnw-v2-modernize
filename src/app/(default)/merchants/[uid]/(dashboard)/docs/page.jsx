...
function Page() {
  ...
  return (
    <Fragment>
      <TitleBar
        title={t('pages.merchants.dashboard.Documents')}
        Right={() => (
          <Button onClick={() => setOpen(true)}>
            {t('pages.merchants.dashboard.Docs Page.addNewDocument')}
          </Button>
        )}
      />
      <SideDialog
        ...
        title={t('pages.merchants.dashboard.Docs Page.addNewDocument')}
