...
import FilterModal from "@/app/(default)/components/merchants/reports/casino-reports/FilterModal";
  ...
  useEffect(() => {
    const columns = [
      ...
      },
      {
        ...
        getActions: (e) => {
          return [
            <IconButton onClick={() => router.push(`/merchants/${params.uid}/reports/casino-reports/${e.id}`)}>
              <IconEye />
            </IconButton>,
