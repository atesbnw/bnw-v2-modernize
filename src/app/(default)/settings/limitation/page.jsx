...
import ActionModal from "@/app/(default)/components/settings/limitation/ActionModal";

const data = [
  {
    id:1,
    category:'system',
    title: 'Basic Limitation Package',
    bgColor: 'info.dark',
    items: [
      {
  ...
  },
  {
    id:2,
    category:'system',
    title: 'Medium Limitation Package',
    bgColor: 'info.dark',
    items: [
      {
        title: 'Casino Upper Limit',
  ...
  },
  {
    id:3,
    category:'system',
    title: 'Advanced Limitation Package',
    bgColor: 'info.dark',
    items: [
      {
        title: 'Casino Upper Limit',
...
function Page() {
  ...
  <Fragment>
    <TitleBar
      title={t("pages.settings.limitation.Limitation")}
      Right={ButtonComps}
    />
