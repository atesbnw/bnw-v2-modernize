...
function Page() {
  ...
  return (
    <Fragment>
      ...
      <TitleBar
        title={t('pages.operator-management.dashboard.Messages')}
        Right={() => (
          <Button onClick={() => setOpen(true)} variant="contained">
            {t('pages.operator-management.dashboard.Messages Page.createNewMessage')}
          </Button>
        )}
      />
      <SideDialog
        ...
        title={t('pages.operator-management.dashboard.Messages Page.createNewMessage')}
