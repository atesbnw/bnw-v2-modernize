...
const StatCards = () => {
  ...
  useEffect(() => {
    setData([
      { title: t("pages.merchants.dashboard.balance"), digits: '5.000,00₺ '},
      { title: t("pages.merchants.dashboard.deposit"), digits: '46.000,00₺'},
      { title: t("pages.merchants.dashboard.withdraw"), digits: '30.000,00₺'},
      { title: t("pages.merchants.dashboard.receivedBonus"), digits: '46.000,00₺'},
      { title: t("pages.merchants.dashboard.canceledBonus"), digits: '6.000,00₺'},
      { title: t("pages.merchants.dashboard.wagered"), digits: '46.000,00₺'},
      { title: t("pages.merchants.dashboard.Total Member Count"), digits: '150'},
      { title: t("pages.merchants.dashboard.Active Member Count"), digits: '24'},
      { title: t("pages.merchants.dashboard.Merchant Earnings"), digits: '20.000,00₺'},
      { title: t("pages.merchants.dashboard.Merchant Commission Rate"), digits: '%42'},
    ]);
  }, []);
