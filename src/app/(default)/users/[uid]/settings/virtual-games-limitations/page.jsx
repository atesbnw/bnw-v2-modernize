...
function Page() {
  ...
  return (
    <Box className={"flex flex-col gap-4"}>
      <TitleBar
        title={t('menu.Users.Settings Menu.Virtual Games Limitations')}
        Right={<ActionModal  modalTitle={t('menu.Users.Settings Menu.Create Virtual Games Limitations', 'Create Virtual Games Limitations')} />}
      />
